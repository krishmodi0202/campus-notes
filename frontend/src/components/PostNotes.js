...
const PostNotes = () => {
  ...
  const facultyMapping = {
    ...
    "EEE": ["Dr. Vima Mali"],
    "C programming": ["Dr. John Smith", "Prof. Sarah Smith"],
    "Ethics": ["Kinnari Patel ", "Ravi Kant"],
    "Civil Engineering": ["Dr. Dhananjay ", " Dr. Anki Deshmukh", "Habal MC"],
    "Mechanical Engineering": ["Dr. Abhanaya GOAT", "Ojas"],
    ...
    "Java": ["Dr. Nandini Modi", "Dr. Deboprata Swain", "Nishu"],
    ...
    "Disaster Management": ["Dr. Ankit Deshmukh"," Debasis phonechor"],
    "Web Tech": ["Dr. Komal Sharma" , "Dr. Debopratap Swain"],
    "AI/ML": ["Dr. Tanmay Bhowmik", "Dawindar Paaji"],
    ...
    "DAA": ["Aditya Shastri","Dr. Hargeet Kaur"]
  };
